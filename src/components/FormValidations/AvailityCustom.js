                    ...
                    <AvForm className="av-tooltip tooltip-label-right" onSubmit={this.handleSubmit}>
                        ...
                        <AvGroup className="error-l-100 error-t-negative">
                            ...
                            <AvField name="confirmationEmail" type="email" validate={{
                                match: { value: 'emailCustomMessage', errorMessage: 'Your inputs does not match' },
                                required: { value: true, errorMessage: 'Please enter your email address' }
                            }} />
                        </AvGroup>
                        ...
                        <AvGroup className="error-l-125 error-t-negative">
                            ...
                            <AvField name="patternPropRegex" type="text" validate={{
                                pattern: {value: /^[A-Z]*$/ , errorMessage: 'Only uppercase characters'},
                                required: { value: true, errorMessage: 'Please enter uppercase characters' } }}  />
                        </AvGroup>
